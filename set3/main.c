...
int main(void) {
  ...
  test_string(upper("AYBABTU"), "AYBABTU");
  test_string(upper(""), "");
  test_string(upper("abcdefghijklmnopqrstuvwxyz"),
  ...
  test_string(lower("aybabtu"), "aybabtu");
  test_string(lower(""), "");
  test_string(lower("ABCDEFGHIJKLMNOPQRSTUVWXYZ"),
              "abcdefghijklmnopqrstuvwxyz");
  ...
  test_string(rot13("All your base are belong to us."),
